...
**Request:**
```http
POST /backend/v3/api/forum/moderation/cases/7001/decisions
...
**Request:**
```http
GET /backend/v3/api/forum/moderation/queue?status=open&severity=high&limit=20
Authorization: Bearer <auth_token>
Access-Token: <access_token>
```
...
**Request:**
```http
POST /backend/v3/api/forum/sanctions
Content-Type: application/json
Authorization: Bearer <auth_token>
Access-Token: <access_token>
...
**Request:**
```http
POST /backend/v3/api/forum/search/reindex
Content-Type: application/json
Authorization: Bearer <auth_token>
Access-Token: <access_token>
...
**Request:**
```http
POST /backend/v3/api/forum/reputation/rules
Content-Type: application/json
Authorization: Bearer <auth_token>
Access-Token: <access_token>
