...
- **Handlers**: Contract-test placeholders returning `ForumRouteError::not_implemented`. Runtime traffic is served by `sdkwork-forum-standalone-gateway/src/routes/app.rs`.
