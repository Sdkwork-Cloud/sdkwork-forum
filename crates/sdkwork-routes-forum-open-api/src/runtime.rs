...
pub fn router() -> Router<AppState> {
    Router::new()
        .route("/forum/v3/api/sites/{site_slug}/boards", get(list_boards))
        .route(
            "/forum/v3/api/sites/{site_slug}/boards/{board_id}/topics",
            get(list_board_topics),
        )
        .route("/forum/v3/api/sites/{site_slug}/topics", get(list_topics))
        .route(
            "/forum/v3/api/sites/{site_slug}/topics/{topic_id}",
            get(retrieve_topic),
        )
        .route(
            "/forum/v3/api/sites/{site_slug}/topics/by_slug/{topic_slug}",
            get(retrieve_topic_by_slug),
        )
        .route(
            "/forum/v3/api/sites/{site_slug}/topics/{topic_id}/replies",
            get(list_replies),
        )
        .route("/forum/v3/api/sites/{site_slug}/tags", get(list_tags))
        .route("/forum/v3/api/sites/{site_slug}/search", get(search))
}
