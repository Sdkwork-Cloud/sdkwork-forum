# sdkwork-forum Source Configuration
...
| `appId` | `sdkwork-forum` |
| `runtimeCode` | `forum` |
| Config root | `/etc/sdkwork/forum/` |
| Runtime TOML | `/etc/sdkwork/forum/config.toml` |
| Secrets | `/etc/sdkwork/forum/secrets/` |
| Override | `SDKWORK_FORUM_CONFIG_FILE` |
